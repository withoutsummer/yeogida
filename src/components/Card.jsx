...
const CardIcon = styled.img`
    width: 1.3em;
    height: 1.3em;
    filter: invert(99%) sepia(0%) saturate(6%) hue-rotate(146deg)
        brightness(92%) contrast(92%);

    &:hover {
        filter: invert(95%) sepia(7%) saturate(4256%) hue-rotate(297deg)
            brightness(85%) contrast(132%);
    }
`;
    ...
    return (
        <CardContainer onClick={onClick}>
            ...
            <CardBody>
                ...
                {icon === 'none' && <CardTitle>{title}</CardTitle>}
                <CardDescription>
            ...
            <CardFooter>
                ...
                <CardLikes>
                    ...
                    >
                        <path
                            d="M14.0843 0C12.3343 0 10.7926 0.875 9.91764 2.25C9.04264 0.875 7.50098 0 5.75098 0C3.00098 0 0.750977 2.25 0.750977 5C0.750977 9.95833 9.91764 15 9.91764 15C9.91764 15 19.0843 10 19.0843 5C19.0843 2.25 16.8343 0 14.0843 0Z"
                            fill="#FC6449"
                        />
                    </svg>
                    <span>{likes}</span>
